1. React make use of React fibre, reconciliation and diff algorithm to make 
    sure that the DOM is updated efficiently.

2. We use react hooks to make sure that the state is updated efficiently and code and UI is in sync.

3. Virtual DOM are just javascript objects which are used to represent the DOM. 
    They are used to make sure that the DOM is updated efficiently.
